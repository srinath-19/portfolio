            ...
            <nav
                ...
                <div
                    className={cn(
                        ...
                        isScrolled &&
                            'bg-[color:var(--color-hero-bg)]/60 max-w-4xl rounded-2xl border border-white/10 backdrop-blur-lg lg:px-5',
                    )}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        ...
                        <div className="bg-[color:var(--color-hero-bg)] group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-white/10 p-6 shadow-2xl shadow-black/40 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                ...
                                <Button
                                    ...
                                    size="sm"
                                    className={cn(
                                        'bg-[color:var(--color-lime)] text-black hover:bg-[color:var(--color-lime)]/90',
                                        isScrolled && 'lg:hidden',
                                    )}>
                                    <Link href="#contact">
                                ...
                                <Button
                                    ...
                                    className={cn(
                                        'bg-[color:var(--color-lime)] text-black hover:bg-[color:var(--color-lime)]/90',
                                        // desktop-only condensed CTA — never duplicate it in the mobile panel
